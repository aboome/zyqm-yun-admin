var TableManaged = function () {
    ...
    return {
        ...
        init: function () {
            ...
            jQuery('#sample_1_wrapper .dataTables_filter input').addClass("form-control input-medium"); // modify table weather input
            ...
            jQuery('#sample_2_wrapper .dataTables_filter input').addClass("form-control input-small"); // modify table weather input
            ...
            jQuery('#sample_3_wrapper .dataTables_filter input').addClass("form-control input-small"); // modify table weather input
            ...
            jQuery('#sample_4 tbody tr .checkboxes').change(function(){
                 $(this).parents('tr').toggleClass("active");
            });

            jQuery('#sample_4_wrapper .dataTables_filter input').addClass("form-control input-medium"); // modify table weather input
