var FormComponents = function () {
    ...
    var handleMultiSelect = function () {
        ...
        $('#my_multi_select3').multiSelect({
            selectableHeader: "<input type='text' class='form-control weather-input' autocomplete='off' placeholder='weather...'>",
            selectionHeader: "<input type='text' class='form-control weather-input' autocomplete='off' placeholder='weather...'>",
